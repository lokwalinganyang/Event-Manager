...
# If DATABASE_URL environment variable exists (in production), use PostgreSQL
if 'DATABASE_URL' in os.environ:
    # This will only run in production where DATABASE_URL is set
    # Hosting platforms will install dj-database-url automatically
    DATABASES['default'] = {
